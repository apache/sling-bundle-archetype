...
# Apache Sling Bundle Archetype (deprecated)
...
For reference or potential bugfix releases use branch [maintenance](https://github.com/apache/sling-bundle-archetype/tree/maintenance).